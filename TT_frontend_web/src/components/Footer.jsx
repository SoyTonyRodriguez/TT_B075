          ...
          <div className="md:absolute md:left-1/2 md:transform md:-translate-x-1/2 text-xs flex items-center">
              <a href="#" className="text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M2 3v18h20V3H2zm18 2v14H4V5h16zm-7 1h-2v4h2V6zm-3 9h2v-2h2v2h2v-2h2v2h2v-2h2v2h2v-2h2v2h2v-2h2v2h-2v4h-4v-4h-2v4h-4v-4h-2v4h-4v-4H4v2h4v-2H4v-4h2v2h2v-2h2v2h2v-2z" />
                </svg>
              </a>
              <a href="#" className="text-white">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
