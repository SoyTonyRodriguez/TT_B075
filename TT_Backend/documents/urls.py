...
from .views import DocumentListCreateAPIView, DocumentUploadAPIView, DocumentReplace, DocumentDeleteAPIView, DocumentRetrieveAPIView
...
urlpatterns = [
    ...
    path('api/v1/document/<str:id>/', DocumentRetrieveAPIView.as_view(), name='document-detail'),
]
