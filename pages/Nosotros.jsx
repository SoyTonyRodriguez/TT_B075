...
function nosotros() {
  return (
    <div className="text-black container mx-auto mt-10 px-4 mb-40"> {/* Agregué mb-10 */}
      ...
      <p className="text-justify mt-4">
        ...
        bajo el nombre clave TT-B075 por los alumnos de la Escuela Superior de Cómputo Casaos Tabaco Luis Ángel, 
